"use strict";
/*
console.log(document.querySelector('.message').textContent); //in nội dung bên trong thẻ ra cửa sổ console
document.querySelector('.message').textContent = 'Correct Number!🥳'; //lấy nội dung bên trong thẻ
